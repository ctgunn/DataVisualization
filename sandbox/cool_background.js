...
(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        Backbone.$ = $;
        var PubSub = require("simple-pubsub"), imagesLoaded = require("imagesloaded"), Helpers = require("./helpers"), Features = require("./features"), BgVideo = require("./bgvideo"), Sound = require("./sound"), Logo = require("./logo"), StartBttn = require("./startbttn"), BbForm = require("./bbform"), Particles = require("./particles"), onWindowResize = _.debounce(function () {
        ...
        $(window).on("resize", onWindowResize), $(function () {
            imagesLoaded($("#preload")[0], function () {
                var e = new BgVideo({
                    src: [{
                        src: "http://4ddcf644184b6f0af2eb-5b9ae5a6dd3bea704a04ede18e6aba70.r72.cf1.rackcdn.com/bluebook_bg3.mp4",
                        type: "video/mp4"
                    }]
                }), r = $("body > footer");
                if (TweenLite.set(e.$el, {opacity: 0}), TweenLite.set(r, {opacity: 0}), TweenLite.to(e.$el, .8, {
                        opacity: 1,
                        ease: Sine.easeOut,
                        onComplete: function () {
                            PubSub.trigger("content:visible"), TweenLite.to(r, .8, {opacity: 1, ease: Sine.easeOut})
                        }
                    }), !(Features.isTouch && (Features.isIOS || Features.isAndroid) || Features.isMobile)) {
                    var i = $(".sound-control");
                    i.css("display", "block"), new Sound({el: i[0], src: ["/assets/media/bluebook_bg_sound.mp3"]})
                }
                new Logo({el: $(".site-header")}), new StartBttn({el: $(".signup-start")}), new BbForm({el: $(".signup-form")}), new Particles
            })
        });
    }, {
        "./bbform": 21,
    ...
    2: [function (require, module, exports) {
        !function (t, e) {
            ...
            {
                var s = t.Backbone, r = [], a = (r.push, r.slice);
                r.splice
            }
            ...
            i.each(l, function (t, e) {
                o[e] = function (e, n, s) {
                    var r = this._listeningTo || (this._listeningTo = {}), a = e._listenId || (e._listenId = i.uniqueId("l"));
            ...
            i.extend(d.prototype, o, {
                changed: null, validationError: null, idAttribute: "id", initialize: function () {
                    ...
                    if (null == t || "object" == typeof t ? (s = t, n = e) : (s = {})[t] = e, n = i.extend({validate: !0}, n), s && !n.wait) {
            ...
            i.extend(p.prototype, o, {
                model: d, initialize: function () {
                    ...
                    for (s = 0, r = t.length; r > s; s++) {
                        if (h = t[s] || {}, a = h instanceof d ? o = h : h[f.prototype.idAttribute || "id"], u = this.get(a)) x && (_[u.cid] = !0), w && (h = h === o ? o.attributes : h, e.parse && (h = u.parse(h, e)), u.set(h, e), p && !c && u.hasChanged(v) && (c = !0)), t[s] = u; else if (b) {
                    ...
                    if (m.length || E && E.length)if (p && (c = !0), this.length += m.length, null != l)for (s = 0, r = m.length; r > s; s++)this.models.splice(l + s, 0, m[s]); else {
            ...
            }, b = /^(\S+)\s*(.*)$/, w = ["model", "collection", "el", "id", "attributes", "className", "tagName", "events"];
            i.extend(_.prototype, o, {
                ...
                if (s.url || (a.url = i.result(n, "url") || j()), null != s.data || !n || "create" !== t && "update" !== t && "patch" !== t || (a.contentType = "application/json", a.data = JSON.stringify(s.attrs || n.toJSON(s))), s.emulateJSON && (a.contentType = "application/x-www-form-urlencoded", a.data = a.data ? {model: a.data} : {}), s.emulateHTTP && ("PUT" === r || "DELETE" === r || "PATCH" === r)) {
            ...
            A.started = !1, i.extend(A.prototype, o, {
                interval: 50, atRoot: function () {
                    ...
                    A.started = !0, this.options = i.extend({root: "/"}, this.options, t), this.root = this.options.root, this._wantsHashChange = this.options.hashChange !== !1, this._wantsPushState = !!this.options.pushState, this._hasPushState = !!(this.options.pushState && this.history && this.history.pushState);
                    var n = this.getFragment(), s = document.documentMode, r = R.exec(navigator.userAgent.toLowerCase()) && (!s || 7 >= s);
        ...
        !function (r) {
            ...
            function r(r, n, s, c) {
                ...
                function E(n) {
                    ...
                    --i;
                    var f = (n - p[i]) / (p[i + 1] - p[i]), c = e + f * a, g = l(c, r, s);
                ...
                for (var z = 0; 4 > z; ++z)if ("number" != typeof arguments[z] || isNaN(arguments[z]) || !isFinite(arguments[z]))throw new Error("BezierEasing arguments should be integers.");
                if (0 > r || r > 1 || 0 > s || s > 1)throw new Error("BezierEasing x values must be in [0, 1] range.");
                var p = f ? new Float32Array(o) : new Array(o), x = !1, B = function (e) {
                    return x || b(), r === n && s === c ? e : 0 === e ? 0 : 1 === e ? 1 : m(E(e), n, c)
                };
                B.getControlPoints = function () {
                    return [{x: r, y: n}, {x: s, y: c}]
                };
                var A = [r, n, s, c], F = "BezierEasing(" + A + ")";
                B.toString = function () {
                    return F
                };
            ...
            var n = this, e = 4, t = .001, i = 1e-7, u = 10, o = 11, a = 1 / (o - 1), f = "Float32Array" in n;
            return r.css = {
                ease: r(.25, .1, .25, 1),
                linear: r(0, 0, 1, 1),
                "ease-in": r(.42, 0, 1, 1),
            ...
            (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
                ...
                _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
                    ...
                    r.version = "1.15.1", l.constructor = r, l.kill()._gc = !1, r.killTweensOf = r.killDelayedCallsTo = i.killTweensOf, r.getTweensOf = i.getTweensOf, r.lagSmoothing = i.lagSmoothing, r.ticker = i.ticker, r.render = i.render, l.invalidate = function () {
                        ...
                        var s, r, o, h, l, u, p, c, f = this._dirty ? this.totalDuration() : this._totalDuration, d = this._time, m = this._totalTime, g = this._cycle, v = this._duration, y = this._rawPrevTime;
                        ...
                        a = a || 0;
                        var c, f, d, m, g = n.delay || 0, v = [], y = function () {
                    ...
                    }, r = 1e-10, n = i._internals, a = s._internals = {}, o = n.isSelector, h = n.isArray, l = n.lazyTweens, _ = n.lazyRender, u = [], p = _gsScope._gsDefine.globals, c = function (t) {
                        var e, i = {};
                        for (e in t)i[e] = t[e];
                        return i
                    ...
                    return s.version = "1.15.1", m.constructor = s, m.kill()._gc = m._forcingPlayhead = !1, m.to = function (t, e, s, r) {
                        ...
                        var s, n, a, o, h, p = this._dirty ? this.totalDuration() : this._totalDuration, c = this._time, f = this._startTime, d = this._timeScale, m = this._paused;
                        if (t >= p ? (this._totalTime = this._time = p, this._reversed || this._hasPausedChild() || (n = !0, o = "onComplete", 0 === this._duration && (0 === t || this._rawPrevTime < 0 || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (h = !0, this._rawPrevTime > r && (o = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = p + 1e-4) : 1e-7 > t ? (this._totalTime = this._time = 0, (0 !== c || 0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (o = "onReverseComplete", n = this._reversed), 0 > t ? (this._active = !1, this._rawPrevTime >= 0 && this._first && (h = !0), this._rawPrevTime = t) : (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (h = !0))) : this._totalTime = this._time = this._rawPrevTime = t, this._time !== c && this._first || i || h) {
                            if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== c && t > 0 && (this._active = !0), 0 === c && this.vars.onStart && 0 !== this._time && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || u)), this._time >= c)for (s = this._first; s && (a = s._next, !this._paused || m);)(s._active || s._startTime <= this._time && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = a; else for (s = this._last; s && (a = s._prev, !this._paused || m);)(s._active || s._startTime <= c && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = a;
                    ...
                    return _.constructor = s, _.kill()._gc = !1, s.version = "1.15.1", _.invalidate = function () {
                        ...
                        this._gc && this._enabled(!0, !1);
                        var s, a, l, _, u, p, c = this._dirty ? this.totalDuration() : this._totalDuration, f = this._duration, d = this._time, m = this._totalTime, g = this._startTime, v = this._timeScale, y = this._rawPrevTime, T = this._paused, x = this._cycle;
                        if (t >= c ? (this._locked || (this._totalTime = c, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (a = !0, _ = "onComplete", 0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && (u = !0, y > r && (_ = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = f, t = f + 1e-4)) : 1e-7 > t ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== d || 0 === f && y !== r && (y > 0 || 0 > t && y >= 0) && !this._locked) && (_ = "onReverseComplete", a = this._reversed), 0 > t ? (this._active = !1, y >= 0 && this._first && (u = !0), this._rawPrevTime = t) : (this._rawPrevTime = f || !e || t || this._rawPrevTime === t ? t : r, t = 0, this._initted || (u = !0))) : (0 === f && 0 > y && (u = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (p = f + this._repeatDelay, this._cycle = this._totalTime / p >> 0, 0 !== this._cycle && this._cycle === this._totalTime / p && this._cycle--, this._time = this._totalTime - this._cycle * p, this._yoyo && 0 !== (1 & this._cycle) && (this._time = f - this._time), this._time > f ? (this._time = f, t = f + 1e-4) : this._time < 0 ? this._time = t = 0 : t = this._time))), this._cycle !== x && !this._locked) {
                            var w = this._yoyo && 0 !== (1 & x), b = w === (this._yoyo && 0 !== (1 & this._cycle)), P = this._totalTime, S = this._cycle, R = this._rawPrevTime, k = this._time;
                        ...
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== m && t > 0 && (this._active = !0), 0 === m && this.vars.onStart && 0 !== this._totalTime && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || n)), this._time >= d)for (s = this._first; s && (l = s._next, !this._paused || T);)(s._active || s._startTime <= this._time && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = l; else for (s = this._last; s && (l = s._prev, !this._paused || T);)(s._active || s._startTime <= d && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i) : s.render((t - s._startTime) * s._timeScale, e, i)), s = l;
                    ...
                    var t = 180 / Math.PI, e = [], i = [], s = [], r = {}, n = _gsScope._gsDefine.globals, a = function (t, e, i, s) {
                        ...
                        var l, _, u, p, c, f, d, m, g, v, y, T, x, w = t.length - 1, b = 0, P = t[0].a;
                        ...
                        var c, f, d, m, g, v, y, T, x = {}, w = [], b = p || t[0];
                        ...
                        if (!h) {
                            for (c = w.length; --c > -1;)if (r[f])for (d = x[w[c]], v = d.length - 1, m = 0; v > m; m++)g = d[m + 1].da / i[m] + d[m].da / e[m], s[m] = (s[m] || 0) + g * g;
                        ...
                        e = e || "soft";
                        var s, r, n, o, h, l, _, u, p, c, f, d = {}, m = "cubic" === e ? 3 : 2, g = "soft" === e, v = [];
                        ...
                        for (var s, r, n, a, o, h, l, _, u, p, c, f = 1 / i, d = t.length; --d > -1;)for (p = t[d], n = p.a, a = p.d - n, o = p.c - n, h = p.b - n, s = r = 0, _ = 1; i >= _; _++)l = f * _, u = 1 - l, s = r - (r = (l * l * a + 3 * u * (l * o + u * h)) * l), c = d * i + _ - 1, e[c] = (e[c] || 0) + s * s
                    }, f = function (t, e) {
                        e = e >> 0 || 6;
                        ...
                        set: function (e) {
                            var i, s, r, n, a, o, h, l, _, u, p = this._segCount, c = this._func, f = this._target, d = e !== this._startRatio;
                            if (this._timeRes) {
                        ...
                        if (t) {
                            ...
                            e._registerComplexSpecialProp("bezier", {
                                parser: function (t, e, n, a, o, h) {
                                    e instanceof Array && (e = {values: e}), h = new d;
                                    var l, _, u, p = e.values, c = p.length - 1, f = [], m = {};
                                    if (0 > c)return o;
                                    for (l = 0; c >= l; l++)u = i(t, p[l], a, o, h, c !== l), f[l] = u.end;
                                    for (_ in e)m[_] = e[_];
                                    return m.values = f, o = new r(t, "bezier", 0, 0, u.pt, 2), o.data = u, o.plugin = h, o.setRatio = s, 0 === m.autoRotate && (m.autoRotate = !0), !m.autoRotate || m.autoRotate instanceof Array || (l = m.autoRotate === !0 ? 0 : Number(m.autoRotate), m.autoRotate = null != u.end.left ? [["left", "top", "rotation", l, !1]] : null != u.end.x ? [["x", "y", "rotation", l, !1]] : !1), m.autoRotate && (a._transform || a._enableTransforms(!1), u.autoRotate = a._target._gsTransform), h._onInitTween(u.proxy, m, a._tween), o
                                }
                            })
                        }
                    ...
                    var _, u, p, c, f, d, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, g = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, v = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, y = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, T = /(?:\d|\-|\+|=|#|\.)*/g, x = /opacity *= *([^)]*)/i, w = /opacity:([^;]*)/i, b = /alpha\(opacity *=.+?\)/i, P = /^(rgb|hsl)/, S = /([A-Z])/g, R = /-([a-z])/gi, k = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, O = function (t, e) {
                        return e.toUpperCase()
                    }, A = /(?:Left|Right|Width)/i, C = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, D = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, M = /,(?=[^\)]*(?:\(|$))/gi, z = Math.PI / 180, F = 180 / Math.PI, X = {}, I = document, N = function (t) {
                        return I.createElementNS ? I.createElementNS("http://www.w3.org/1999/xhtml", t) : I.createElement(t)
                    }, L = N("div"), E = N("img"), Y = a._internals = {_specialProps: h}, B = navigator.userAgent, U = function () {
                        var t = B.indexOf("Android"), e = N("a");
                        ...
                        if (c && (s = -s), "%" === r && -1 !== i.indexOf("border")) o = s / 100 * (_ ? t.clientWidth : t.clientHeight); else {
                            if (p.cssText = "border:0 solid red;position:" + $(t, "position") + ";line-height:0;", "%" !== r && u.appendChild) p[_ ? "borderLeftWidth" : "borderTopWidth"] = s + r; else {
                        ...
                        var s = "left" === e ? "Left" : "Top", r = $(t, "margin" + s, i);
                        return t["offset" + s] - (Q(t, e, parseFloat(r), r.replace(T, "")) || 0)
                    }, K = function (t, e) {
                        var i, s, r = {};
                        if (e = e || G(t, null))for (i in e)(-1 === i.indexOf("Transform") || we === i) && (r[i] = e[i]); else if (e = t.currentStyle || t.style)for (i in e)"string" == typeof i && void 0 === r[i] && (r[i.replace(R, O)] = e[i]);
                        ...
                        var e, i, s, r, n, a;
                        return t && "" !== t ? "number" == typeof t ? [t >> 16, t >> 8 & 255, 255 & t] : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), oe[t] ? oe[t] : "#" === t.charAt(0) ? (4 === t.length && (e = t.charAt(1), i = t.charAt(2), s = t.charAt(3), t = "#" + e + e + i + i + s + s), t = parseInt(t.substr(1), 16), [t >> 16, t >> 8 & 255, 255 & t]) : "hsl" === t.substr(0, 3) ? (t = t.match(m), r = Number(t[0]) % 360 / 360, n = Number(t[1]) / 100, a = Number(t[2]) / 100, i = .5 >= a ? a * (n + 1) : a + n - a * n, e = 2 * a - i, t.length > 3 && (t[3] = Number(t[3])), t[0] = he(r + 1 / 3, e, i), t[1] = he(r, e, i), t[2] = he(r - 1 / 3, e, i), t) : (t = t.match(m) || oe.transparent, t[0] = Number(t[0]), t[1] = Number(t[1]), t[2] = Number(t[2]), t.length > 3 && (t[3] = Number(t[3])), t)) : oe.black
                    ...
                    var ue = function (t, e, i, s) {
                        ...
                        var r, n = e ? (t.match(_e) || [""])[0] : "", a = t.split(n).join("").match(v) || [], o = t.substr(0, t.indexOf(a[0])), h = ")" === t.charAt(t.length - 1) ? ")" : "", l = -1 !== t.indexOf(" ") ? " " : ",", _ = a.length, u = _ > 0 ? a[0].replace(m, "") : "";
                        return _ ? r = e ? function (t) {
                                    ...
                                    if (e = (t.match(_e) || [n])[0], p = t.split(e).join("").match(v) || [], c = p.length, _ > c--)for (; ++c < _;)p[c] = i ? p[(c - 1) / 2 | 0] : a[c];
                                    ...
                                    if (e = t.match(v) || [], p = e.length, _ > p--)for (; ++p < _;)e[p] = i ? e[(p - 1) / 2 | 0] : a[p];
                                    return o + e.join(l) + h
                                } : function (t) {
                                return t
                            }
                        ...
                        var a, o, h, l, _, u = s, p = {}, c = {}, f = i._transform, d = X;
                        for (i._transform = null, X = e, s = _ = i.parse(t, e, s, r), X = d, n && (i._transform = f, u && (u._prev = null, u._prev && (u._prev._next = null))); s && s !== u;) {
                            if (s.type <= 1 && (o = s.p, c[o] = s.s + s.c, p[o] = s.s, n || (l = new ce(s, "s", o, l, s.r), s.c = 0), 1 === s.type))for (a = s.l; --a > 0;)h = "xn" + a, o = s.p + "_" + h, c[o] = s.data[h], p[o] = s[h], n || (l = new ce(s, h, o, l, s.rxp[h]));
                            s = s._next
                        }
                    ...
                    var Te, xe = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), we = Z("transform"), be = q + "transform", Pe = Z("transformOrigin"), Se = null !== Z("perspective"), Re = Y.Transform = function () {
                    ...
                    }, ke = window.SVGElement, Oe = function (t, e, i) {
                        var s, r = I.createElementNS("http://www.w3.org/2000/svg", t), n = /([a-z])([A-Z])/g;
                        for (s in i)r.setAttributeNS(null, s.replace(n, "$1-$2").toLowerCase(), i[s]);
                        return e.appendChild(r), r
                    }, Ae = document.documentElement, Ce = function () {
                        var t, e, i, s = d || /Android/i.test(B) && !window.chrome;
                        return I.createElementNS && !s && (t = Oe("svg", Ae), e = Oe("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        ...
                        var n, o, h, l, _, u, p, c, f, d, m = i ? t._gsTransform || new Re : new Re, g = m.scaleX < 0, v = 2e-5, y = 1e5, T = Se ? parseFloat($(t, Pe, e, !1, "0 0 0").split(" ")[2]) || m.zOrigin || 0 : 0, x = parseFloat(a.defaultTransformPerspective) || 0;
                        if (we ? o = $(t, be, e, !0) : t.currentStyle && (o = t.currentStyle.filter.match(C), o = o && 4 === o.length ? [o[0].substr(4), Number(o[2].substr(4)), Number(o[1].substr(4)), o[3].substr(4), m.x || 0, m.y || 0].join(",") : ""), n = !o || "none" === o || "matrix(1, 0, 0, 1, 0, 0)" === o, m.svg = !!(ke && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)), m.svg && (De(t, $(t, Pe, r, !1, "50% 50%") + "", m), Te = a.useSVGTransformAttr || Ce, h = t.getAttribute("transform"), n && h && -1 !== h.indexOf("matrix") && (o = h, n = 0)), !n) {
                            ...
                            if (16 === h.length) {
                                var w, b, P, S, R, k = h[0], O = h[1], A = h[2], D = h[3], M = h[4], z = h[5], X = h[6], I = h[7], N = h[8], L = h[9], E = h[10], Y = h[12], B = h[13], U = h[14], j = h[11], V = Math.atan2(X, E);
                                ...
                                var q = h.length >= 6, W = q ? h[0] : 1, Z = h[1] || 0, G = h[2] || 0, Q = q ? h[3] : 1;
                        ...
                        if (p) {
                            ...
                            var c, f, m = this.t.offsetWidth, g = this.t.offsetHeight, v = "absolute" !== p.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + o + ", M12=" + h + ", M21=" + l + ", M22=" + _, w = s.x + m * s.xPercent / 100, b = s.y + g * s.yPercent / 100;
                        ...
                        var e, i, s, r, n, a, o, h, l, _, u, p, f, d, m, g, v, y, T, x, w, b = this.data, P = this.t.style, S = b.rotation * z, R = b.scaleX, k = b.scaleY, O = b.scaleZ, A = b.x, C = b.y, D = b.z, M = b.perspective;
                        if (!(1 !== t && 0 !== t && b.force3D || b.force3D === !0 || b.rotationY || b.rotationX || 1 !== O || M || D))return void Xe.call(this, t);
                        if (c && (d = 1e-4, d > R && R > -d && (R = O = 2e-5), d > k && k > -d && (k = O = 2e-5), !M || b.z || b.rotationX || b.rotationY || (M = 0)), S || b.skewX) m = e = Math.cos(S), g = r = Math.sin(S), b.skewX && (S -= b.skewX * z, m = Math.cos(S), g = Math.sin(S), "simple" === b.skewType && (v = Math.tan(b.skewX * z), v = Math.sqrt(1 + v * v), m *= v, g *= v)), i = -g, n = m; else {
                        ...
                        var e, i, s, r, n, a, o, h, l, _, u, p = this.data, c = this.t, f = c.style, d = p.x, m = p.y;
                    ...
                    l = Re.prototype, l.x = l.y = l.z = l.skewX = l.skewY = l.rotation = l.rotationX = l.rotationY = l.zOrigin = l.xPercent = l.yPercent = 0, l.scaleX = l.scaleY = l.scaleZ = 1, ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                        parser: function (t, e, i, s, n, o, h) {
                            ...
                            var l, _, u, p, c, f, d, m = s._transform = Me(t, r, !0, h.parseTransform), g = t.style, v = 1e-6, y = xe.length, T = h, x = {};
                            if ("string" == typeof T.transform && we) u = L.style, u[we] = T.transform, u.display = "block", u.position = "absolute", I.body.appendChild(L), l = Me(L, null, !1), I.body.removeChild(L); else if ("object" == typeof T) {
                                if (l = {
                                    ...
                                    }, d = T.directionalRotation, null != d)if ("object" == typeof d)for (u in d)T[u] = d[u]; else T.rotation = d;
                        ...
                        defaultValue: "0px", parser: function (t, e, i, n, a) {
                            e = this.format(e);
                            var o, h, l, _, u, p, c, f, d, m, g, v, y, T, x, w, b = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], P = t.style;
                        ...
                        defaultValue: "0 0", parser: function (t, e, i, s, n, a) {
                            var o, h, l, _, u, p, c = "background-position", f = r || G(t, null), m = this.format((f ? d ? f.getPropertyValue(c + "-x") + " " + f.getPropertyValue(c + "-y") : f.getPropertyValue(c) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), g = this.format(e);
                    ...
                    ve("opacity,alpha,autoAlpha", {
                        defaultValue: "1", parser: function (t, e, i, s, n, a) {
                            var o = parseFloat($(t, "opacity", r, !1, "1")), h = t.style, l = "autoAlpha" === i;
                    ...
                    ve("className", {
                        parser: function (t, e, s, n, a, o, h) {
                            var l, _, u, p, c, f = t.getAttribute("class") || "", d = t.style.cssText;
                    ...
                    var Be = function (t, e, i) {
                        var s, r, n, a;
                        if (t.slice)for (r = t.length; --r > -1;)Be(t[r], e, i); else for (s = t.childNodes, r = s.length; --r > -1;)n = s[r], a = n.type, n.style && (e.push(K(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Be(n, e, i)
                    };
                    return a.cascadeTo = function (t, i, s) {
                        var r, n, a, o = e.to(t, i, s), h = [o], l = [], _ = [], u = [], p = e._internals.reservedProps;
                        for (t = o._targets || o.target, Be(t, l, u), o.render(i, !0), Be(t, _), o.render(0, !0), o._enabled(!0), r = u.length; --r > -1;)if (n = J(u[r], l[r], _[r]), n.firstMPT) {
                            n = n.difs;
                ...
                if (!i.TweenLite) {
                    ...
                    var P = t.requestAnimationFrame, S = t.cancelAnimationFrame, R = Date.now || function () {
                    ...
                    g("Ticker", function (t, e) {
                        var i, s, r, n, h, l = this, u = R(), c = e !== !1 && P, f = 500, d = 33, m = "tick", g = function (t) {
                            var e, a, o = R() - k;
                    ...
                    var F = [], X = {}, I = D._internals = {
                        isArray: c,
                        isSelector: M,
                        lazyTweens: F
                    }, N = D._plugins = {}, L = I.tweenLookup = {}, E = 0, Y = I.reservedProps = {
                        ease: 1,
                        delay: 1,
                        overwrite: 1,
                        onComplete: 1,
                        ...
                        "true": 1,
                        "false": 0
                    }, U = O._rootFramesTimeline = new C, j = O._rootTimeline = new C, V = I.lazyRender = function () {
                        var t, e = F.length;
                    ...
                    n._init = function () {
                        ...
                        for (n in this.vars) {
                            if (_ = this.vars[n], Y[n]) _ && (_ instanceof Array || _.push && c(_)) && -1 !== _.join("").indexOf("{self}") && (this.vars[n] = _ = this._swapSelfInParams(_, this)); else if (N[n] && (h = new N[n])._onInitTween(e, this.vars[n], this)) {
                                for (this._firstPT = l = {
                                    _next: this._firstPT,
                                    t: h,
                                    p: "setRatio",
    ...
    5: [function (require, module, exports) {
        (function (global) {
            "use strict";
            var base = require("./handlebars/base"), SafeString = require("./handlebars/safe-string")["default"], Exception = require("./handlebars/exception")["default"], Utils = require("./handlebars/utils"), runtime = require("./handlebars/runtime"), create = function () {
    ...
    6: [function (require, module, exports) {
        ...
        function registerDefaultHelpers(e) {
            e.registerHelper("helperMissing", function () {
                ...
                if (r.data && r.ids) {
                    ...
                    a.contextPath = Utils.appendContextPath(r.data.contextPath, r.name), r = {data: a}
                }
                return i(t, r)
                ...
                var n, i, a = t.fn, s = t.inverse, l = 0, o = "";
                if (t.data && t.ids && (i = Utils.appendContextPath(t.data.contextPath, t.ids[0]) + "."), isFunction(e) && (e = e.call(this)), t.data && (n = createFrame(t.data)), e && "object" == typeof e)if (isArray(e))for (var c = e.length; c > l; l++)r(l, l, l === e.length - 1); else {
                    var p;
                ...
                if (t.data && t.ids) {
                    ...
                    n.contextPath = Utils.appendContextPath(t.data.contextPath, t.ids[0]), t = {data: n}
                }
                return r(e, t)
        ...
        var Utils = require("./utils"), Exception = require("./exception")["default"], VERSION = "3.0.0";
        ...
        exports.HandlebarsEnvironment = HandlebarsEnvironment, HandlebarsEnvironment.prototype = {
            ...
            registerPartial: function (e, t) {
                if (toString.call(e) === objectType) Utils.extend(this.partials, e); else {
    ...
    8: [function (require, module, exports) {
        ...
        function checkRevision(e) {
            var r = e && e[0] || 1, t = COMPILER_REVISION;
            if (r !== t) {
                if (t > r) {
                    var n = REVISION_CHANGES[t], a = REVISION_CHANGES[r];
        ...
        function template(e, r) {
            ...
            var t = function (t, n, a) {
                ...
                strict: function (e, r) {
                    ...
                    for (var t = e.length, n = 0; t > n; n++)if (e[n] && null != e[n][r])return e[n][r]
                }, lambda: function (e, r) {
                    return "function" == typeof e ? e.call(r) : e
                }, escapeExpression: Utils.escapeExpression, invokePartial: t, fn: function (r) {
                    return e[r]
                }, programs: [], program: function (e, r, t, n, a) {
                    var o = this.programs[e], i = this.fn(e);
                ...
                }, noop: r.VM.noop, compilerInfo: e.compiler
            }, a = function (r, t) {
                t = t || {};
                var o = t.data;
        ...
        var Utils = require("./utils"), Exception = require("./exception")["default"], COMPILER_REVISION = require("./base").COMPILER_REVISION, REVISION_CHANGES = require("./base").REVISION_CHANGES, createFrame = require("./base").createFrame;
    ...
    10: [function (require, module, exports) {
        ...
        function extend(t) {
            for (var r = 1; r < arguments.length; r++)for (var n in arguments[r])Object.prototype.hasOwnProperty.call(arguments[r], n) && (t[n] = arguments[r][n]);
            return t
        }

        function indexOf(t, r) {
            for (var n = 0, e = t.length; e > n; n++)if (t[n] === r)return n;
            return -1
        }
    ...
    12: [function (require, module, exports) {
        !function () {
            ...
            i.prototype = {
                volume: function (e) {
                    ...
                    if (e = parseFloat(e), e >= 0 && 1 >= e) {
                        ...
                        for (var t in o._howls)if (o._howls.hasOwnProperty(t) && o._howls[t]._webAudio === !1)for (var r = 0; r < o._howls[t]._audioNode.length; r++)o._howls[t]._audioNode[r].volume = o._howls[t]._volume * o._volume;
                        return o
                    }
                    ...
                    for (var t in o._howls)if (o._howls.hasOwnProperty(t) && o._howls[t]._webAudio === !1)for (var r = 0; r < o._howls[t]._audioNode.length; r++)o._howls[t]._audioNode[r].muted = e
                }, codecs: function (e) {
                    ...
                    if (!o || !e._iOSEnabled && /iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                        e._iOSEnabled = !1;
                        var n = function () {
                            var t = o.createBuffer(1, 1, 22050), r = o.createBufferSource();
            ...
            var l = new i(d), f = function (e) {
                var t = this;
                t._autoplay = e.autoplay || !1, t._buffer = e.buffer || !1, t._duration = e.duration || 0, t._format = e.format || null, t._loop = e.loop || !1, t._loaded = !1, t._sprite = e.sprite || {}, t._src = e.src || "", t._pos3d = e.pos3d || [0, 0, -.5], t._volume = void 0 !== e.volume ? e.volume : 1, t._urls = e.urls || [], t._rate = e.rate || 1, t._model = e.model || null, t._onload = [e.onload || function () {
                }], t._onloaderror = [e.onloaderror || function () {
                }], t._onend = [e.onend || function () {
                }], t._onpause = [e.onpause || function () {
                }], t._onplay = [e.onplay || function () {
                }], t._onendTimer = [], t._webAudio = n && !t._buffer, t._audioNode = [], t._webAudio && t._setupAudioNode(), "undefined" != typeof o && o && l.iOSAutoEnable && l._enableiOSAudio(), l._howls.push(t), t.load()
            };
            if (f.prototype = {
                    load: function () {
                        var e = this, o = null;
                        ...
                        if (e._src = o, e._webAudio) _(e, o); else {
                            var u = new Audio;
                        ...
                        return "function" == typeof e && (n = e), e && "function" != typeof e || (e = "_default"), t._loaded ? t._sprite[e] ? (t._inactiveNode(function (r) {
                                    r._sprite = e;
                                    var a = r._pos > 0 ? r._pos : t._sprite[e][0] / 1e3, i = 0;
                                    ...
                                    if (function () {
                                        ...
                                        var _ = t._sprite[e][0] / 1e3, s = t._sprite[e][1] / 1e3;
                                        ...
                                        if (4 !== r.readyState && (r.readyState || !navigator.isCocoonJS))return t._clearEndTimer(f), function () {
                                            var o = t, a = e, i = n, u = r, d = function () {
                        ...
                        if (n)if (n._pos = o.pos(null, e), o._webAudio) {
                        ...
                        if (e >= 0)return t;
                        for (var a = 0; a < t._audioNode.length; a++)if (t._audioNode[a].paused && 4 === t._audioNode[a].readyState)return t._webAudio ? t._audioNode[a]._pos : t._audioNode[a].currentTime
                        ...
                        var a = this, i = Math.abs(e - o), u = e > o ? "down" : "up", d = i / .01, l = n / d;
                        if (!a._loaded)return a.on("load", function () {
                            a.fade(e, o, n, t, r)
                        }), a;
                        a.volume(e, r);
                        for (var f = 1; d >= f; f++)!function () {
                            var e = a._volume + ("up" === u ? .01 : -.01) * f, n = Math.round(1e3 * e) / 1e3, i = o;
                            setTimeout(function () {
                        ...
                        for (var o = this, n = o._audioNode[0], t = 0; t < o._audioNode.length; t++)if (o._audioNode[t].id === e) {
                            n = o._audioNode[t];
                            break
                        }
                        return n
                    }, _activeNode: function () {
                        for (var e = this, o = null, n = 0; n < e._audioNode.length; n++)if (!e._audioNode[n].paused) {
                            o = e._audioNode[n];
                            break
                        }
                        return e._drainPool(), o
                    }, _inactiveNode: function (e) {
                        for (var o = this, n = null, t = 0; t < o._audioNode.length; t++)if (o._audioNode[t].paused && 4 === o._audioNode[t].readyState) {
                            e(o._audioNode[t]), n = !0;
                            break
                        }
                        if (o._drainPool(), !n) {
                            var r;
                            if (o._webAudio) r = o._setupAudioNode(), e(r); else {
                                o.load(), r = o._audioNode[o._audioNode.length - 1];
                                var a = navigator.isCocoonJS ? "canplaythrough" : "loadedmetadata", i = function () {
                        ...
                        for (var o = this, n = 0, t = 0; t < o._onendTimer.length; t++)if (o._onendTimer[t].id === e) {
                            n = t;
                            break
                        }
                        ...
                        var e = this, n = e._audioNode, t = e._audioNode.length;
                        ...
                        var n = this, t = n["_on" + e];
                        if ("function" == typeof o) t.push(o); else for (var r = 0; r < t.length; r++)o ? t[r].call(n, o) : t[r].call(n);
                        return n
                    }, off: function (e, o) {
                        var n = this, t = n["_on" + e], r = o ? o.toString() : null;
                        if (r) {
                            for (var a = 0; a < t.length; a++)if (r === t[a].toString()) {
                                t.splice(a, 1);
                                break
                            }
                        } else n["_on" + e] = [];
    ...
    }, {"eventie": 14, "wolfy87-eventemitter": 15}],
    ...
    17: [function (require, module, exports) {
        var Backbone = require("backbone"), _ = require("underscore"), PubSub = {};
        _.extend(PubSub, Backbone.Events), module.exports = PubSub;


    }, {"backbone": 2, "underscore": 18}],
    ...
    19: [function (require, module, exports) {
        (function () {
            ...
            var e = this, u = e._, i = Array.prototype, o = Object.prototype, a = Function.prototype, c = i.push, l = i.slice, f = o.toString, s = o.hasOwnProperty, p = Array.isArray, h = Object.keys, v = a.bind, g = Object.create, y = function () {
            }, m = function (n) {
    ...
    20: [function (require, module, exports) {
        !function () {
            ...
            function ka(e, i, o) {
                ...
                var n = t.i.D({source: o, parentEl: e.c}, e.q[i.toLowerCase()]);
            ...
            function P(e, i) {
                ...
                "" + o in e || Object.defineProperty(e, o, {
                    ...
                    this.o("change")
                })), e.Va.push(i), e.o({type: "addtrack", U: i})
            }

            function Q(t, e) {
                for (var i, o = 0, n = t.length; n > o; o++)if (i = t[o], i === e) {
                    t.Va.splice(o, 1);
                    break
                }
                t.o({type: "removetrack", U: e})
            }
            ...
            t.ic = "4.12", t.vd = "https:" == document.location.protocol ? "https://" : "http://", t.VERSION = "4.12.1", t.options = {
                ...
                n.G || (n.G = {}), n.G[i] || (n.G[i] = []), o.s || (o.s = t.s++), n.G[i].push(o), n.ca || (n.disabled = l, n.ca = function (i) {
                    if (!n.disabled) {
                        i = t.Pb(i);
                        var o = n.G[i.type];
                        if (o)for (var o = o.slice(0), s = 0, r = o.length; r > s && !i.Rc(); s++)o[s].call(e, i)
                    }
                ...
                if (t.Mc(e)) {
                    ...
                    if (n.G) {
                        ...
                        if (i) {
                            ...
                            if (s) {
                                if (o) {
                                    if (o.s)for (n = 0; n < s.length; n++)s[n].s === o.s && s.splice(n--, 1)
                                } else n.G[i] = [];
                                t.Ac(e, i)
                            }
                        } else for (s in n.G)i = s, n.G[i] = [], t.Ac(e, i)
                    }
                }
            }, t.Ac = function (e, i) {
                var o = t.getData(e);
            ...
            C ? (D = C[1] && parseFloat(C[1]), E = C[2] && parseFloat(C[2]), B = D && E ? parseFloat(C[1] + "." + C[2]) : D ? D : j) : B = j, ba.hc = B, t.Ed = t.zd && /webkit/i.test(t.P) && 2.3 > t.hc, t.jc = /Firefox/i.test(t.P), t.lf = /Chrome/i.test(t.P), t.oa = /MSIE\s8\.0/.test(t.P), t.Eb = !!("ontouchstart" in window || window.xd && document instanceof window.xd), t.wd = "backgroundSize" in t.A.style, t.ed = function (e, i) {
                ...
                var i, o, n, s;
                s = "protocol hostname port pathname search hash host".split(" "), o = t.e("a", {href: e}), (n = "" === o.host && "file:" !== o.protocol) && (i = t.e("div"), i.innerHTML = '<a href="' + e + '"></a>', o = i.firstChild, i.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(i)), e = {};
                ...
                if (t.i.isArray(e) && i instanceof Function)for (var n = 0, s = e.length; s > n; ++n)i.call(o || t, e[n], n, e);
                return e
            }, t.ff = function (e, i) {
                var o, n, s, r, a, c, l;
                "string" == typeof e && (e = {uri: e}), videojs.$.ya({
                    method: "GET",
                    timeout: 45e3
                }, e), i = i || m(), c = function () {
                ...
                var i = e.type || e;
                "string" == typeof e && (e = {type: i}), e = t.Pb(e), this.bb[i] && this["on" + i] && this["on" + i](e), t.o(this, e)
                ...
                var e, i, o, n, s, r;
                if (e = this, i = e.options(), o = i.children)if (r = function (t, o) {
                        i[t] !== b && (o = i[t]), o !== l && (e[t] = e.ba(t, o))
                    }, t.i.isArray(o))for (var a = 0; a < o.length; a++)n = o[a], "string" == typeof n ? (s = n, n = {}) : s = n.name, r(s, n); else t.i.da(o, r)
                ...
                return i = t.i.D({
                    ...
                    "aria-live": "polite",
                    tabIndex: 0
                }, i), o = t.a.prototype.e.call(this, e, i), i.innerHTML || (this.B = t.e("div", {className: "vjs-control-content"}), this.Jb = t.e("span", {
            ...
            if (K)for (t.cb.Rb = {}, L = 0; L < K.length; L++)t.cb.Rb[ha[L]] = K[L];
            t.Player = t.a.extend({
                l: function (e, i, o) {
                ...
                for (var i = 0, o = this.q.techOrder; i < o.length; i++) {
                    var n = t.ua(o[i]), s = window.videojs[n];
                    if (s) {
                        if (s.isSupported())for (var r = 0, a = e; r < a.length; r++) {
                            var c = a[r];
                            if (s.canPlaySource(c))return {source: c, h: n}
                        }
                    } else t.log.error('The "' + n + '" tech is undefined. Skipped browser support check for that tech.')
                }
                return l
            }, s.src = function (e) {
                return e === b ? M(this, "src") : (t.i.isArray(e) ? ma(this, e) : "string" == typeof e ? this.src({src: e}) : e instanceof Object && (e.type && !window.videojs[this.Ua].canPlaySource(e) ? ma(this, [e]) : (this.K.src = e.src, this.Gc = e.type || "", this.I(function () {
            ...
            }), t.Cb.prototype.q = {children: {seekBar: {}}}, t.Cb.prototype.e = function () {
            ...
            }),t.Gb.prototype.q = {children: {volumeBar: {}}},t.Gb.prototype.e = function () {
                ...
                var e = new t.pa(this.d, {Cc: "div"}), i = new t.Fb(this.d, this.q.volumeBar);
                ...
                var e = new t.pa(this.k()), i = this.k().options().playbackRates;
                if (i)for (var o = i.length - 1; o >= 0; o--)e.ba(new t.Bb(this.k(), {rate: i[o] + "x"}));
                return e
            },s.Ca = function () {
                this.m().setAttribute("aria-valuenow", this.k().playbackRate())
            },s.u = function () {
                for (var t = this.k().playbackRate(), e = this.k().options().playbackRates, i = e[0], o = 0; o < e.length; o++)if (e[o] > t) {
                    i = e[o];
                    break
                }
            ...
            t.j = t.a.extend({
                ...
                return t = O(this, t.kind, t.label, t.language, t), P(this.Z(), t), {U: t}
                ...
                t.Ra = function (e, i) {
                    ...
                    for (var i, o = t.gd || [], n = 0; n < o.length; n++)if (i = o[n].eb(e))return o[n];
                    return j
                }, t.zc = function (e) {
                    var i = t.pb(e);
                    return i ? i.eb(e) : ""
                ...
                if (!s || this.movingMediaElementInDOM === l) {
                    if (s ? (o = s.cloneNode(l), t.f.Mb(s), s = o, n.L = j) : (s = t.e("video"), o = videojs.$.ya({}, n.Xe), (!t.Eb || n.options().nativeControlsForTouch !== f) && delete o.controls, t.ed(s, t.i.D(o, {
                                id: n.id() + "_html5_api",
                                "class": "vjs-tech"
                            }))), s.player = n, n.q.qd)for (o = 0; o < n.q.qd.length; o++)e = n.q.qd[o], i = document.createElement("track"), i.Wb = e.Wb, i.label = e.label, i.hd = e.hd, i.src = e.src, "default" in e && i.setAttribute("default", "default"), s.appendChild(i);
                    t.Ub(s, n.m())
                }
                ...
                var i, o;
                for (Q(this.Z(), e), i = this.m().querySelectorAll("track"), o = 0; o < i.length; o++)if (i[o] === e || i[o].track === e) {
            ...
            t.f.Xc = function () {
                ...
                l: function (e, i, o) {
                    ...
                    var n = i.source;
                    o = i.parentEl;
                    var s = this.c = t.e("div", {id: e.id() + "_temp_flash"}), r = e.id() + "_flash_api", a = e.q, a = t.i.D({
                        ...
                        loop: a.loop,
                        muted: a.muted
                    }, i.flashVars), c = t.i.D({wmode: "opaque", bgcolor: "#000000"}, i.params), r = t.i.D({
                        id: r,
                        name: r,
                        "class": "vjs-tech"
                    }, i.attributes);
            ...
            t.g.isSupported = function () {
                ...
                o.error("srcnotfound" == i ? {code: 4, message: n} : n)
                ...
                e = t.g.ce(e, o, n, s), e = t.e("div", {innerHTML: e}).childNodes[0], o = i.parentNode, i.parentNode.replaceChild(e, i);
                ...
                }), n = t.i.D({data: e, width: "100%", height: "100%"}, n), t.i.da(n, function (t, e) {
                    a += t + '="' + e + '" '
                }), '<object type="application/x-shockwave-flash" ' + a + ">" + r + "</object>"
            }, t.g.Ue = {"rtmp/mp4": "MP4", "rtmp/flv": "FLV"}, t.g.Hf = function (t, e) {
                return t + "&" + e
            }, t.g.Te = function (t) {
                var e = {Bc: "", md: ""};
                if (!t)return e;
                ...
                l: function (e, i, o) {
                    if (t.a.call(this, e, i, o), e.q.sources && 0 !== e.q.sources.length) e.src(e.q.sources); else for (i = 0, o = e.q.techOrder; i < o.length; i++) {
                        var n = t.ua(o[i]), s = window.videojs[n];
                        if (s && s.isSupported()) {
                            ka(e, n);
                            break
            ...
            }), t.rc = {disabled: "disabled", hidden: "hidden", showing: "showing"}, t.Hd = {
                subtitles: "subtitles",
                captions: "captions",
                ...
                if (i = this, t.oa)for (d in i = document.createElement("custom"), t.t.prototype)i[d] = t.t.prototype[d];
                return i.d = e.player, n = t.rc[e.mode] || "disabled", s = t.Hd[e.kind] || "subtitles", r = e.label || "", a = e.language || e.srclang || "", o = e.id || "vjs_text_track_" + t.s++, ("metadata" === s || "chapters" === s) && (n = "hidden"), i.W = [], i.Ga = [], c = new t.V(i.W), u = new t.V(i.Ga), p = l, h = t.bind(i, function () {
                    ...
                    get: function () {
                        ...
                        if (p = l, i.length !== this.Ga.length) p = f; else for (t = 0; t < i.length; t++)-1 === ua.call(this.Ga, i[t]) && (p = f);
                        return this.Ga = i, u.qb(this.Ga), u
                    }, set: Function.prototype
                }), e.src ? va(e.src, i) : i.Xb = f, t.oa ? i : void 0
            }, t.t.prototype = t.i.create(t.z.prototype), t.t.prototype.constructor = t.t, t.t.prototype.bb = {cuechange: "cuechange"}, t.t.prototype.vc = function (t) {
                var e = this.d.textTracks(), i = 0;
                if (e)for (; i < e.length; i++)e[i] !== this && e[i].bd(t);
            ...
            va = function (e, i) {
                ...
                var i, o = this, n = 0;
                if (t.oa)for (i in o = document.createElement("custom"), t.F.prototype)o[i] = t.F.prototype[i];
            ...
            t.F.prototype.de = function (t) {
                for (var e, i = 0, o = this.length, n = j; o > i; i++)if (e = this[i], e.id === t) {
                    n = e;
                    break
                }
                return n
                ...
                var i, o = this;
                if (t.oa)for (i in o = document.createElement("custom"), t.V.prototype)o[i] = t.V.prototype[i];
                return t.V.prototype.qb.call(o, e), Object.defineProperty(o, "length", {get: n("pe")}), t.oa ? o : void 0
                ...
                if (this.W = t, this.pe = t.length, t = function (t) {
                    ...
                    }, o > e)for (i = e; o > i; i++)t.call(this, i)
            ...
            if (t.ra.prototype.C = function () {
                    ...
                    if (this.Pd(), e)for (; i < e.length; i++)t = e[i], "showing" === t.mode && this.cf(t)
                    ...
                    if ("function" == typeof window.WebVTT && t.activeCues) {
                        ...
                        for (window.WebVTT.processCues(window, t.activeCues, this.c), i = n.length; i--;) {
                            ...
                            } else t.style.backgroundColor = o.fc;
                    ...
                    l: function (e, i) {
                        var o, n, s = this.U = i.track, r = e.textTracks();
                        r && (o = t.bind(this, function () {
                            var e, i, o, n = "showing" === this.U.mode;
                            if (this instanceof t.Ab)for (n = f, i = 0, o = r.length; o > i; i++)if (e = r[i], e.kind === this.U.kind && "showing" === e.mode) {
                                n = l;
                                break
                            }
                            this.selected(n)
                    ...
                    var e, i = this.U.kind, o = this.d.textTracks(), n = 0;
                    if (t.M.prototype.u.call(this), o)for (; n < o.length; n++)e = o[n], e.kind === i && (e.mode = e === this.U ? "showing" : "disabled")
                }, t.Ab = t.aa.extend({
                    l: function (e, i) {
                        i.track = {
                            kind: i.kind,
                    ...
                    var e, i, o = [];
                    if (this instanceof t.na && (!this.k().h || !this.k().h.featuresNativeTextTracks) && o.push(new t.tb(this.d, {kind: this.fa})), o.push(new t.Ab(this.d, {kind: this.fa})), i = this.d.textTracks(), !i)return o;
                    for (var n = 0; n < i.length; n++)e = i[n], e.kind === this.fa && o.push(new t.aa(this.d, {track: e}));
                    return o
                }, t.na = t.Q.extend({
                    l: function (e, i, o) {
                    ...
                    for (var e, i, o = this.d.textTracks() || [], n = 0, s = o.length, r = this.H = []; s > n; n++)if (e = o[n], e.kind == this.fa) {
                        if (e.Dc) {
                            i = e;
                            break
                        }
                    ...
                    l: function (e, i) {
                        var o = this.U = i.track, n = this.cue = i.cue, s = e.currentTime();
                ...
                t.JSON.parse = function (a, c) {
                    function d(t, e) {
                        var i, o, n = t[e];
                        if (n && "object" == typeof n)for (i in n)Object.prototype.hasOwnProperty.call(n, i) && (o = d(n, i), o !== b ? n[i] = o : delete n[i]);
                        return c.call(t, e, n)
                    }
            ...
            t.xc = function () {
                ...
                var s = [];
                if (e && 0 < e.length)for (o = 0, n = e.length; n > o; o++)s.push(e[o]);
                if (i && 0 < i.length)for (o = 0, n = i.length; n > o; o++)s.push(i[o]);
                if (s && 0 < s.length)for (o = 0, n = s.length; n > o; o++) {
            ...
            var r = "auto", a = {"": !0, lr: !0, rl: !0}, c = {start: !0, middle: !0, end: !0, left: !0, right: !0};
            ...
            function r(t, e) {
                ...
                for (var c, l = t.document.createElement("div"), u = l, h = []; null !== (c = o());)if ("<" !== c[0]) u.appendChild(t.document.createTextNode(s(c))); else {
                    if ("/" === c[1]) {
            ...
            function a(t) {
                ...
                for (e(n, t); s = i(n);)for (var r = 0; r < s.length; r++) {
                    o = s.charCodeAt(r);
                    for (var a = 0; a < g.length; a++)if (g[a] === o)return "rtl"
                }
                return "ltr"
            }
            ...
            e.prototype = f(Error.prototype), e.prototype.constructor = e, e.Errors = {
                ...
                set: function (t, e) {
                    ...
                    for (var o = 0; o < i.length; ++o)if (e === i[o]) {
                        this.set(t, e);
                        break
                    }
            ...
            d.processCues = function (t, e, i) {
                ...
                if (n.style.position = "absolute", n.style.left = "0", n.style.right = "0", n.style.top = "0", n.style.bottom = "0", n.style.margin = T, i.appendChild(n), o(e)) {
                    var s = [], r = h.getSimpleBoxPosition(n), a = Math.round(r.height * w * 100) / 100, c = {font: a + "px " + j};
                    !function () {
                ...
                reportOrThrowError: function (t) {
                    ...
                    var c = this;
                    t && (c.buffer += c.decoder.decode(t, {stream: !0}));
                    try {
                        var l;
                        if ("INITIAL" === c.state) {
    ...
    21: [function (require, module, exports) {
        var _ = require("underscore"), PubSub = require("simple-pubsub"), BezierEasing = require("bezier-easing"), Backbone = require("backbone"), videojs = require("video.js"), Helpers = require("./helpers"), Features = require("./features"), Globals = require("./globals"), BbFormFooter = require("./bbformfooter");
        module.exports = Backbone.View.extend({
            ...
            initialize: function () {
                this.state = "form", this.$fields = this.$(".signup-form-field"), this.$inputs = this.$("input"), this.$labels = this.$("label"), this.footer = new BbFormFooter({el: this.$(".signup-form-footer")}), this.$success = this.$(".signup-form-success-message"), this.listenTo(PubSub, "startbttn:expanded", this.reveal), this.listenTo(PubSub, "state:change", this.onStateChange)
            },
            reset: function () {
                this.state = "form", this.slideForm(0, !0), this.footer.hide(!0), this.$inputs.each(function () {
                    var e = $(this);
                    e.val(e.attr("data-placeholder")), e.css("visibility", "visible"), TweenLite.set(e, {opacity: 0})
                }), this.$success.css("visibility", "hidden").text(""), this.$fields.css("visibility", "visible"), TweenLite.set(this.$fields, {opacity: .6}), this.$labels.css("visibility", "visible"), TweenLite.set(this.$labels, {opacity: 0})
            },
            reveal: function (e) {
                ...
                this.$fields.each(function (e) {
                    TweenLite.set(this, {yPercent: -100 * e, y: i})
                }), TweenLite.set(this.$fields.first(), {opacity: 1}), this.$el.css("visibility", "visible");
                var t = new TimelineLite;
                this.$fields.each(function () {
                    t.to(this, 26 / 30, {yPercent: 0, y: 0, ease: this.ease}, 0)
                }), this.$inputs.each(function (e) {
                    t.to(this, .4, {opacity: 1, ease: Sine.easeInOut}, (20 + 6 * e) / 30)
                })
            },
            ...
            hideFieldPlaceholder: function (e) {
                ...
                if (i == e.attr("data-placeholder")) {
                    e.val("");
                    var t = e.siblings("label").first();
                    TweenLite.to(t, 16 / 30, {opacity: .7, ease: Sine.easeInOut})
                }
            },
            deSelectFields: function (e) {
                TweenLite.to(e, .5, {opacity: .6, ease: Sine.easeInOut})
            },
            selectFields: function (e) {
                TweenLite.to(e, 22 / 30, {opacity: 1, ease: Sine.easeInOut})
            },
            slideForm: function (e, i) {
                var t = 100 * (e + 1) / -3;
                Features.isTouch && (t = 200 / -3), i ? TweenLite.set(this.$el, {yPercent: t}) : TweenLite.to(this.$el, 26 / 30, {
                        yPercent: t,
                        ease: this.ease
                    })
            },
            onFocus: function (e) {
                var i = $(e.target), t = i.parent();
            ...
            onKeyUp: function (e) {
                var i = $(e.target), t = i.parent(), s = e.key || e.keyCode || e.which;
                if (13 === s) {
                    var n = t.index();
            ...
            sendData: function (e) {
                if (console.log("BbForm.sendData", arguments), e && e.preventDefault(), this.isComplete()) {
                    ...
                    $.ajax({
                        type: "POST", url: "/api.php", data: i, success: function () {
                        }
            ...
            transitionToShare: function () {
                ...
                i.to(this.$el, 26 / 30, {yPercent: -100, ease: this.ease}, 0), this.$fields.each(function (t) {
                    t >= e || i.to(this, 16 / 30, {
                        opacity: 0,
                        ease: Sine.easeInOut,
                ...
                t = t[0], this.$success.text("Thank you for signing up, " + t), this.$success.css("visibility", "visible"), TweenLite.set(this.$success, {opacity: 0}), i.to(this.$success, 16 / 30, {
                    opacity: 1,
                    ease: Sine.easeInOut
            ...
            shareTwitter: function (e) {
                e.preventDefault();
                var i = "https://twitter.com/share", t = $.param({
    ...
    22: [function (require, module, exports) {
        var _ = require("underscore"), PubSub = require("simple-pubsub"), Backbone = require("backbone"), Helpers = require("./helpers"), LinedBttn = require("./linedbttn");
        module.exports = Backbone.View.extend({
            events: {}, initialize: function () {
                this.submitBttn = new LinedBttn({el: this.$(".signup-form-submit")}), this.$share = this.$(".signup-form-share"), this.$shareMessage = this.$(".signup-form-share-message"), this.$shareButtons = this.$(".signup-form-share > div"), this.isVisible = !1, this.state = "submit"
            }, show: function () {
                this.isVisible || "submit" == this.state && (TweenLite.killTweensOf(this.$el), TweenLite.set(this.$el, {opacity: 1}), this.isVisible = !0, this.submitBttn.reset(), this.submitBttn.$el.css("display", "block"), this.submitBttn.show())
            }, showShare: function () {
                this.submitBttn.$el.css("display", "none"), TweenLite.set(this.$shareMessage, {opacity: 0}), TweenLite.set(this.$shareButtons, {opacity: 0}), this.$share.css("display", "block"), TweenLite.to(this.$shareMessage, 17 / 30, {
                    delay: .5,
                    opacity: 1,
                    ease: Sine.easeInOut
                }), TweenLite.to(this.$shareButtons, 17 / 30, {delay: 20 / 30, opacity: 1, ease: Sine.easeInOut})
            }, switchToShare: function () {
                this.submitBttn.hide(this.showShare.bind(this))
            }, hide: function (e) {
                this.isVisible = !1, e ? (this.submitBttn.$el.css("display", "none"), this.$share.css("display", "none"), TweenLite.set(this.$el, {opacity: 1})) : TweenLite.to(this.$el, 17 / 30, {
                        opacity: 0,
                        ease: Sine.easeInOut,
                        onCompleteScope: this,
                        onComplete: function () {
                            this.submitBttn.$el.css("display", "none"), this.$share.css("display", "none"), TweenLite.set(this.$el, {opacity: 1})
                        }
                    })
            }
        });
    ...
    }, {"./helpers": 27, "./linedbttn": 28, "backbone": 2, "simple-pubsub": 16, "underscore": 19}],
    23: [function (require, module, exports) {
        var _ = require("underscore"), PubSub = require("simple-pubsub"), BezierEasing = require("bezier-easing"), Features = require("./features"), toFixedOne = function (t) {
            ...
            this.props = {
                ...
                stroke_0: 0,
                stroke_1: 0
            }, this.strokeWidth = 8, this.el = t, this.paths = [[], []], this.b_pen = [331.2, 7.9], this.b_offset = 23.7, this.b_d_attribute = ["M0,0", "M0,0"], this.lengths = [[], []], this.duration = 37 / 30, this.getPaths(), this.getBPens(), this.computeLengths(), this.setupTimeline()
        };
        BbLogo.prototype.easing = {
            ...
            for (var t = 0; t < this.paths[0].length; t++) {
                var e = this.paths[0][t], s = this.paths[0][t].getAttribute("d");
            ...
            for (var t = 0; t < this.paths.length; t++)for (var e = 0; e < this.paths[t].length; e++) {
                var s = this.paths[t][e], i = s.getTotalLength();
            ...
            var e = $(".site-motto")[0];
            this.timeline.to(e, 20 / 30, {opacity: 1, ease: Cubic.easeInOut}, 1.2)
        }, BbLogo.prototype.animate = function () {
            this.timeline.play()
        }, module.exports = BbLogo;


    }, {"./features": 25, "bezier-easing": 3, "simple-pubsub": 16, "underscore": 19}],
    24: [function (require, module, exports) {
        var _ = require("underscore"), Backbone = require("backbone"), videojs = require("video.js"), Helpers = require("./helpers"), Features = require("./features");
        module.exports = Backbone.View.extend({
            aspect: 16 / 9,
            mouse_region: 0,
            offsets: [0, 0, 0],
            ...
            hidePoster: function () {
                TweenLite.to(this.$poster, .6, {opacity: 0})
            },
            fitVideo: function () {
                var e = $(window), t = Helpers.getCoverDimensions(this.aspect, e.width(), e.height());
            ...
            initPlayer: function () {
                ...
                var t = this, i = videojs(this.$el.find(".video-js")[0], {
                    controls: !1,
                    preload: "auto",
                    techOrder: ["html5", "flash"],
                    loop: !0
                ...
                i.on("canplay", function () {
                    ...
                    var i = e.target.error ? e.target.error.code : e.code, o = {
    ...
    25: [function (require, module, exports) {
        var addDocClass = function (i) {
            var e = document.documentElement, a = "" == e.className ? "" : " ";
        ...
        if ("Microsoft Internet Explorer" == navigator.appName) {
            ...
            var ua = navigator.userAgent, re = new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})");
            null !== re.exec(ua) && (isIe = parseFloat(RegExp.$1))
        }
        ...
        var maxSize = 736, isMobile = window.innerWidth <= maxSize && window.outerWidth <= maxSize ? !0 : !1, isTouch = !1;
    ...
    26: [function (require, module, exports) {
        module.exports = {STATE_INTRO: "intro", STATE_FORM: "form"};
    ...
    27: [function (require, module, exports) {
        ...
        var getWindowSize = function () {
            var e = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, t = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
            ...
            var o = void 0 !== window.screenLeft ? window.screenLeft : screen.left, r = void 0 !== window.screenTop ? window.screenTop : screen.top, d = window.innerWidth ? window.innerWidth : document.documentElement.clientWidth ? document.documentElement.clientWidth : screen.width, c = window.innerHeight ? window.innerHeight : document.documentElement.clientHeight ? document.documentElement.clientHeight : screen.height, u = d / 2 - t / 2 + o, w = c / 2 - n / 2 + r, h = e, m = "status=1,width=" + t + ",height=" + n + ",top=" + w + ",left=" + u;
            window.open(h, i, m)
        };
        module.exports = {
    ...
    28: [function (require, module, exports) {
        var _ = require("underscore"), PubSub = require("simple-pubsub"), Backbone = require("backbone"), Features = require("./features"), Helpers = require("./helpers");
        module.exports = Backbone.View.extend({
            lineOpacityMax: .7,
            widths: {start: 5, live: 90, hover: 128},
            events: {mouseenter: "onMouseEnter", mouseleave: "onMouseLeave"},
            initialize: function () {
                this.$line = this.$(".line"), this.$text = this.$("a"), this.reset()
            },
            reset: function () {
                this.isLive = !1, TweenLite.set(this.$text, {opacity: 0}), TweenLite.set(this.$line, {
            ...
            show: function (e) {
                ...
                }, 7 / 30), t.to(this.$line, 20 / 30, {width: this.widths.live, ease: Cubic.easeInOut}, 14 / 30)
            },
            hide: function (e) {
                this.isLive = !1;
                var t = new TimelineLite({
                ...
                t.to(this.$text, .4, {
                    ...
                    width: this.widths.start,
                    ease: Cubic.easeInOut
                }, 0), t.to(this.$line, 8 / 30, {opacity: 0, ease: Linear.easeNone}, 20 / 30)
            },
            onMouseEnter: function () {
                this.isLive && (Features.isTouch || (TweenLite.to(this.$text, 10 / 30, {
                    opacity: .5,
                    ease: Cubic.easeOut
                }), TweenLite.to(this.$line, 10 / 30, {width: this.widths.hover, ease: Cubic.easeInOut})))
            },
            onMouseLeave: function () {
                this.isLive && (Features.isTouch || (TweenLite.to(this.$text, 10 / 30, {
                    opacity: 1,
                    ease: Cubic.easeOut
                }), TweenLite.to(this.$line, 10 / 30, {width: this.widths.live, ease: Cubic.easeInOut})))
            }
        });


    }, {"./features": 25, "./helpers": 27, "backbone": 2, "simple-pubsub": 16, "underscore": 19}],
    29: [function (require, module, exports) {
        var _ = require("underscore"), Backbone = require("backbone"), PubSub = require("simple-pubsub"), BezierEasing = require("bezier-easing"), videojs = require("video.js"), Helpers = require("./helpers"), Features = require("./features"), Globals = require("./globals"), BbLogo = require("./bblogo");
        module.exports = Backbone.View.extend({
            lineOpacityMax: .6,
            width: {responsive: Features.isMobile ? 80 : 42.9, fixed: 160},
            easing: new Ease(BezierEasing(.6, 0, 0, 1)),
            events: {"click .bb-logo": "onLogoClick"},
            initialize: function () {
                this.currentState = Globals.STATE_INTRO, this.isMinimized = !1, this.$logo = this.$(".bb-logo"), this.logo = new BbLogo(this.$logo[0]), this.$world = this.$(".site-header-world"), TweenLite.set(this.$world, {
                    xPercent: -50,
                    yPercent: -92
                }), this.$world.css({width: this.width.responsive + "%"}), this.$text = this.$(".site-motto"), this.listenTo(PubSub, "content:visible", this.reveal), this.listenTo(PubSub, "startbttn:transitionlogo", this.minimize), this.listenTo(PubSub, "state:change", this.onStateChange), this.mouse = {
                    x: 0,
                    y: 0
            ...
            minimize: function () {
                if (!this.isMinimized) {
                    ...
                    TweenLite.to(this.$logo, 35 / 30, {
                        ...
                        opacity: 0,
                        ease: Cubic.easeInOut
                    }), TweenLite.to(this.$el, 35 / 30, {yPercent: -100, y: 45, ease: this.easing})
                }
            },
            maximize: function () {
                if (this.isMinimized) {
                    this.isMinimized = !1, this.$el.removeClass("minimized");
                    var i = this.$el.width() * this.width.responsive / 100, e = this.width.fixed / i;
                    TweenLite.set(this.$logo, {scale: e}), this.$world.css({width: this.width.responsive + "%"}), TweenLite.to(this.$logo, 35 / 30, {
                        scale: 1,
                        ease: this.easing
                    }), TweenLite.to(this.$text, 20 / 30, {
                        opacity: 1,
                        ease: Cubic.easeInOut
                    }), TweenLite.to(this.$el, 35 / 30, {yPercent: 0, y: 0, ease: this.easing})
                }
            },
            rotate3d: function () {
                if (!this.isMinimized) {
                    var i = this.mouse.x / window.innerWidth * 2 - 1, e = 2 * -(this.mouse.y / window.innerHeight) + 1;
            ...
            fixRotation: function () {
                TweenLite.to(this.$world, 25 / 30, {x: 0, y: 0, rotationX: 0, rotationY: 0, ease: Quart.easeOut})
            },
            trackMouse: function () {
    ...
    31: [function (require, module, exports) {
        ...
        module.exports = Backbone.View.extend({
            ...
            particlesCenter: {x: 0, y: 0, z: 350},
            cameraYRot: 8 * Math.PI / 180,
            cameraXRot: 14 * Math.PI / 180,
            addCube: function (e, t, i) {
                var s = new THREE.BoxGeometry(4, 4, 4), r = new THREE.MeshBasicMaterial({color: 16776960}), a = new THREE.Mesh(s, r);
                a.position.x = e, a.position.y = t, a.position.z = i, this.scene.add(a)
            },
            initialize: function () {
                this.isAnimating = !1, this.listenTo(PubSub, "state:change", this.onStateChange), this.renderer = new THREE.WebGLRenderer({alpha: !0}), this.renderer.setPixelRatio(window.devicePixelRatio || 1), this.renderer.setSize(window.innerWidth, window.innerHeight), this.$el.insertAfter($(".bg-video")), this.$el.append(this.renderer.domElement), TweenLite.set(this.$el, {opacity: 0}), this.scene = new THREE.Scene, this.lookAt = new THREE.Vector3(0, 0, -1 * this.particlesCenter.z), this.createCamera(), this.createWorld(), this.listenTo(PubSub, "content:visible", function () {
            ...
            computeBounds: function () {
                ...
                var e = Helpers.twoToThree(new THREE.Vector3(-1, 1, 0), this.camera, this.particlePlane), t = Helpers.twoToThree(new THREE.Vector3(1, -1, 0), this.camera, this.particlePlane);
            ...
            createLines: function () {
                var e = require("../shaders/line.vert"), t = require("../shaders/line.frag"), i = new THREE.ShaderMaterial({
                    vertexShader: e(),
                    fragmentShader: t(),
                    vertexColors: THREE.VertexColors,
                    transparent: !0,
                        ...
                        for (var h = a; h < this.particlesList.length; h++) {
                            ...
                            if (!(c.age < 1)) {
                                ...
                                if (l < this.maxEdgeLength) {
                                    ...
                                    var d = 1, p = l / this.maxEdgeLength;
                                    p > .5 && (d = 2 - 2 * p);
                                    var m = this.maxLineOpacity * Math.min(n.opacity, c.opacity), u = new THREE.Color(d, m, d);
            ...
            updateLines: function () {
                for (var e = 0, t = !1, i = 0; i < this.particlesList.length; i++) {
                    var s = this.particlesList[i], r = 0;
                    if (t)break;
                    for (var a = i; a < this.particlesList.length; a++) {
                        var n = this.particlesList[a], o = s.vertex.distanceToSquared(n.vertex);
                        if (o < this.maxEdgeLength) {
                            ...
                            var h = 2 * (e - 1), c = 1 - o / this.maxEdgeLength;
            ...
            updateCamera: function () {
                if (!this.isResizing) {
                    var e = this.mouse.x / window.innerWidth * 2 - 1, t = 2 * -(this.mouse.y / window.innerHeight) + 1;
                    TweenLite.killTweensOf(this.camera.position), TweenLite.killTweensOf(this.camera.rotation);
                    var i = this.camera.position.clone(), s = this.camera.rotation.clone(), r = new THREE.Euler(-50 * e, -30 * t, i.z), a = this.lookAt.clone();
                    ...
                    this.camera.position.copy(i), this.camera.rotation.copy(s), TweenLite.to(this.camera.position, 25 / 30, {
                        ...
                        y: r.y,
                        ease: Quart.easeOut
                    }), TweenLite.to(this.camera.rotation, 25 / 30, {x: n.x, y: n.y, z: n.z, ease: Quart.easeOut})
                }
            },
            start: function () {
            ...
            fadeView: function (e, t) {
                TweenLite.to(this.$el, t, {opacity: e, ease: Sine.easeInOut})
            }
        });
    }, {
    ...
    32: [function (require, module, exports) {
        !function () {
            ...
            }, i = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], o = i.length, t = window.console = window.console || {}; o--;)n = i[o], t[n] || (t[n] = e)
        }(), function () {
            ...
            window.requestAnimationFrame || (window.requestAnimationFrame = function (e) {
                var i = (new Date).getTime(), o = Math.max(0, 16 - (i - n)), t = window.setTimeout(function () {
                    e(i + o)
                }, o);
                return n = i + o, t
    ...
    33: [function (require, module, exports) {
        require("howler");
        var _ = require("underscore"), Backbone = require("backbone"), Helpers = require("./helpers"), Features = require("./features");
        module.exports = Backbone.View.extend({
            events: {click: "toggle"}, initialize: function (e) {
                e = e || {}, this.isMuted = !0;
                var t = this;
                this.sound = new Howl({
                    urls: e.src, buffer: !0, loop: !0, onload: function () {
                        t.unmute();
                        this.play()
                    }
                })
    ...
    }, {"./features": 25, "./helpers": 27, "backbone": 2, "howler": 12, "underscore": 19}],
    34: [function (require, module, exports) {
        var _ = require("underscore"), PubSub = require("simple-pubsub"), Backbone = require("backbone"), videojs = require("video.js"), Helpers = require("./helpers"), Features = require("./features"), Globals = require("./globals"), LinedBttn = require("./linedbttn");
        module.exports = Backbone.View.extend({
            lineOpacityMax: .7,
            events: {
            ...
            reset: function () {
                this.$text.css({opacity: 0}), this.$line.css({left: "50%", width: "5px", opacity: 0})
            },
            reveal: function () {
                var e = new TimelineLite({
                    delay: .6, onCompleteScope: this, onComplete: function () {
                        this.isLive = !0
                    }
                });
                e.to(this.$text, 14 / 30, {
                    ...
                    opacity: this.lineOpacityMax,
                    ease: Linear.easeNone
                }, .3), e.to(this.$line, 26 / 30, {width: "90px", ease: Cubic.easeInOut}, 17 / 30)
            },
            onClick: function () {
                PubSub.trigger("state:change", Globals.STATE_FORM), this.transitionAnimation()
            },
            transitionAnimation: function () {
                this.isLive = !1, TweenLite.set(this.$text, {opacity: .25});
                var e = new TimelineLite({delay: .1});
                e.set(this.$text, {opacity: .5}, 0), e.to(this.$text, 8 / 30, {
                    opacity: 0,
                    ease: Sine.easeInOut
            ...
            onMouseEnter: function () {
                this.isLive && (Features.isTouch || (TweenLite.to(this.$text, 10 / 30, {
                    opacity: .5,
                    ease: Cubic.easeOut
                }), TweenLite.to(this.$line, 10 / 30, {width: "128px", ease: Cubic.easeInOut})))
            },
            onMouseLeave: function () {
                this.isLive && (Features.isTouch || (TweenLite.to(this.$text, 10 / 30, {
                    opacity: 1,
                    ease: Cubic.easeOut
                }), TweenLite.to(this.$line, 10 / 30, {width: "90px", ease: Cubic.easeInOut})))
            }
        });
    ...
    37: [function (require, module, exports) {
        ...
        module.exports = templater({
            compiler: [6, ">= 2.0.0-beta.1"], main: function () {
                return '<div class="bg-video-container">\n  <img class="bg-video-poster" src="/assets/img/poster.jpg">\n</div>'
            }, useData: !0
        });
